    ...
    <div className={className} aria-hidden="true">
      <div className="relative aspect-[3/2] w-full overflow-hidden rounded-[3px] ring-1 ring-ink/15">
        {Object.keys(ALT).map((s) => (
          ...
          // These are pre-sized, pre-encoded WebP at exactly 1x/2x, lazy, and
          // far below the fold; next/image would re-optimise already-optimised
          // bytes and add a loader for no gain. Never the LCP element.
